...
<head>
    ...
    <link rel="stylesheet" href="admin\html\assets\css/libs.min.css">
    <link rel="stylesheet" href="admin\html\assets\css/socialv.css">
    ...
    <link rel="stylesheet" href="admin\html\assets\vendor\vanillajs-datepicker\dist\css/datepicker.min.css">
    <link rel="stylesheet" href="admin\html\assets\vendor\line-awesome\dist\font-awesome-line-awesome\css/all.min.css">
        ...
        <div id="sidebar-scrollbar">
            <nav class="iq-sidebar-menu">
                <ul id="iq-sidebar-toggle" class="iq-menu">
                    <li class="active">
                        <a href="admin\html\dashboard/index.html" class=" ">
                    ...
                    <li class=" ">
                        ...
                        <ul id="mailbox" class="iq-submenu collapse" data-bs-parent="#iq-sidebar-toggle">
                            <li class="">
                                <a href="admin\html\app/email.html"><i class="  ri-inbox-line"></i>Inbox</a>
                            </li>
                            <li class="">
                                <a href="admin\html\app/email-compose.html"><i class="ri-edit-line"></i>Email Compose</a>
                            </li>
                        </ul>
                    </li>
                    <li class="">
                                ...
                                <div class="card shadow-none m-0">
                                    ...
                                    <div class="card-body p-0 ">
                                        ...
                                        <div class="d-inline-block w-100 text-center p-3">
                                            <a class="btn btn-primary iq-sign-btn" href="admin\html\dashboard" role="button">Sign
        ...
        <div class="container">
            <div class="row">
                        ...
                        <div id="post-modal-data" class="card card-block card-stretch card-height">
                            ...
                            <div class="card-body">
                                ...
                                <ul class=" post-opt-block d-flex list-inline m-0 p-0 flex-wrap">
                                    ...
                                    <li class="me-3 mb-md-0 mb-2">
                                        <a href="#" class="btn btn-soft-primary">
                                            <img src="admin\html\assets\images\small/08.png" alt="icon" class="img-fluid me-2"> Tag Friend
                                        </a>
                                    </li>
                                    <li class="me-3">
                                        <a href="#" class="btn btn-soft-primary">
                                            <img src="admin\html\assets\images\small/09.png" alt="icon" class="img-fluid me-2"> Feeling/Activity
                                        </a>
                                    </li>
                                    <li>
                            ...
                            <div class="card-body">
                                <div class="user-post-data">
                                    <div class="d-flex justify-content-between">
                                        <div class="me-3">
                                            <img class="rounded-circle img-fluid" src="admin\html\assets\images\user/01.jpg" alt="">
                                        </div>
                                        <div class="w-100">
                                            <div class="d-flex justify-content-between">
                                                <div class="">
                                ...
                                <div class="user-post">
                                    <div class=" d-grid grid-rows-2 grid-flow-col gap-3">
                                        <div class="row-span-2 row-span-md-1">
                                            <img src="admin\html\assets\images\page-img/p2.jpg" alt="post-image" class="img-fluid rounded w-100">
                                        </div>
                                        <div class="row-span-1">
                                            <img src="admin\html\assets\images\page-img/p1.jpg" alt="post-image" class="img-fluid rounded w-100">
                                        </div>
                                        <div class="row-span-1 ">
                                            <img src="admin\html\assets\images\page-img/p3.jpg" alt="post-image" class="img-fluid rounded w-100">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card card-block card-stretch card-height">
                            <div class="card-body">
                                <div class="user-post-data">
                                    <div class="d-flex justify-content-between">
                                        <div class="me-3">
                                            <img class="rounded-circle img-fluid" src="admin\html\assets\images\user/03.jpg" alt="">
                                        </div>
                                        <div class="w-100">
                                            <div class="d-flex  justify-content-between">
                                                <div class="">
                                ...
                                <div class="user-post">
                                    <a href="javascript:void();"><img src="admin\html\assets\images\page-img/p4.jpg" alt="post-image" class="img-fluid rounded w-100"></a>
                                </div>
                                <div class="comment-area mt-3">
                                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                                        <div class="like-block position-relative d-flex align-items-center">
                        ...
                        <div class="card card-block card-stretch card-height">
                            <div class="card-body">
                                <div class="user-post-data">
                                    <div class="d-flex justify-content-between">
                                        <div class="me-3">
                                            <img class="rounded-circle img-fluid" src="admin\html\assets\images\user/04.jpg" alt="">
                                        </div>
                                        <div class="w-100">
                                            <div class=" d-flex  justify-content-between">
                                                <div class="">
                        ...
                        <div class="card card-block card-stretch card-height">
                            <div class="card-body">
                                <div class="post-item">
                                    <div class="d-flex justify-content-between">
                                        <div class="me-3">
                                            <img class="rounded-circle img-fluid avatar-60" src="admin\html\assets\images\user/1.jpg" alt="">
                                        </div>
                                        <div class="w-100">
                                            <div class="d-flex justify-content-between">
                                                <div class="">
                                ...
                                <div class="user-post text-center">
                                    <a href="javascript:void();"><img src="admin\html\assets\images\page-img/p5.jpg" alt="post-image" class="img-fluid rounded w-100 mt-3"></a>
                                </div>
                                <div class="comment-area mt-3">
                                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                                        <div class="like-block position-relative d-flex align-items-center">
                        ...
                        <div class="card card-block card-stretch card-height">
                            <div class="card-body">
                                <div class="user-post-data">
                                    <div class="d-flex justify-content-between">
                                        <div class="me-3">
                                            <img class="rounded-circle img-fluid" src="admin\html\assets\images\user/02.jpg" alt="">
                                        </div>
                                        <div class="w-100">
                                            <div class="d-flex justify-content-between">
                                                <div class="">
                ...
                <div class="col-lg-4">
                        ...
                        <div class="card-body">
                            <ul class="media-story list-inline m-0 p-0">
                                ...
                                <li class="d-flex mb-3 align-items-center active">
                                    <img src="admin\html\assets\images\page-img/s2.jpg" alt="story-img" class="rounded-circle img-fluid">
                                    <div class="stories-data ms-3">
                                        <h5>Anna Mull</h5>
                                ...
                                <li class="d-flex mb-3 align-items-center">
                                    <img src="admin\html\assets\images\page-img/s3.jpg" alt="story-img" class="rounded-circle img-fluid">
                                    <div class="stories-data ms-3">
                                        <h5>Ira Membrit</h5>
                                ...
                                <li class="d-flex align-items-center">
                                    <img src="admin\html\assets\images\page-img/s1.jpg" alt="story-img" class="rounded-circle img-fluid">
                                    <div class="stories-data ms-3">
                                        <h5>Bob Frapples</h5>
                        ...
                        <div class="card-body">
                            <ul class="media-story list-inline m-0 p-0">
                                <li class="d-flex mb-4 align-items-center ">
                                    <img src="admin\html\assets\images\page-img/s4.jpg" alt="story-img" class="rounded-circle img-fluid">
                                    <div class="stories-data ms-3">
                                        <h5>Web Workshop</h5>
                                        <p class="mb-0">1 hour ago</p>
                                    </div>
                                ...
                                <li class="d-flex align-items-center">
                                    <img src="admin\html\assets\images\page-img/s5.jpg" alt="story-img" class="rounded-circle img-fluid">
                                    <div class="stories-data ms-3">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <ul class="media-story list-inline m-0 p-0">
                                <li class="d-flex mb-4 align-items-center">
                                    <img src="admin\html\assets\images\user/01.jpg" alt="story-img" class="rounded-circle img-fluid">
                                    <div class="stories-data ms-3">
                                        <h5>Anna Sthesia</h5>
                                ...
                                <li class="d-flex align-items-center">
                                    <img src="admin\html\assets\images\user/02.jpg" alt="story-img" class="rounded-circle img-fluid">
                                    <div class="stories-data ms-3">
                                        <h5>Paul Molive</h5>
                            ...
                            <ul class="suggested-page-story m-0 p-0 list-inline">
                                <li class="mb-3">
                                    <div class="d-flex align-items-center mb-3">
                                        <img src="admin\html\assets\images\page-img/42.png" alt="story-img" class="rounded-circle img-fluid avatar-50">
                                        <div class="stories-data ms-3">
                                            <h5>Iqonic Studio</h5>
                                            <p class="mb-0">Lorem Ipsum</p>
                                        </div>
                                    </div>
                                    <img src="admin\html\assets\images\small/img-1.jpg" class="img-fluid rounded" alt="Responsive image">
                                ...
                                <li class="">
                                    ...
                                    <img src="admin\html\assets\images\small/img-2.jpg" class="img-fluid rounded" alt="Responsive image">
                                    <div class="mt-3"><a href="#" class="btn d-block"><i class="ri-thumb-up-line me-2"></i> Like Page</a></div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="col-sm-12 text-center">
                    <img src="admin\html\assets\images\page-img/page-load-loader.gif" alt="loader" style="height: 100px;">
                </div>
            </div>
        </div>
    </div>
...
<script src="admin\html\assets\jsadmin\html\dashboard/libs.min.js"></script>
<!-- slider JavaScript -->
<script src="admin\html\assets\jsadmin\html\dashboard/slider.js"></script>
<!-- masonry JavaScript -->
<script src="admin\html\assets\jsadmin\html\dashboard/masonry.pkgd.min.js"></script>
<!-- SweetAlert JavaScript -->
<script src="admin\html\assets\jsadmin\html\dashboard/enchanter.js"></script>
<!-- SweetAlert JavaScript -->
<script src="admin\html\assets\js/sweetalert.js"></script>
<!-- app JavaScript -->
<script src="public\admin\html\assets\js\charts/weather-chart.js"></script>
<script src="admin\html\assets\js/app.js"></script>
<script src="admin\html\assets\vendor\vanillajs-datepicker\dist\js\datepicker.min.js"></script>
<script src="admin\html\assets\js/lottie.js"></script>
