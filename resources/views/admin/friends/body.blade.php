...
<div class="header-for-bg">
    <div class="background-header position-relative">
        <img src="../admin/html/assets/images/page-img/profile-bg3.jpg" class="img-fluid w-100" alt="header-bg">
                    ...
                    <div class="card-body profile-page p-0">
                        <div class="profile-header-image">
                            <div class="cover-container">
                                <img src="../admin/html/assets/images/page-img/profile-bg2.jpg" alt="profile-bg" class="rounded img-fluid w-100">
                            </div>
                                    ...
                                    <div class="d-flex flex-wrap justify-content-between align-items-start">
                                        <div class="profile-detail d-flex">
                                            <div class="profile-img pe-4">
                                                <img src="../admin/html/assets/images/user/05.jpg" alt="profile-img" class="avatar-130 img-fluid" />
                                            </div>
                                ...
                                <div class="user-detail">
                                    <div class="d-flex flex-wrap justify-content-between align-items-start">
                                        <div class="profile-detail d-flex">
                                            ...
                                            <div class="user-data-block">
                                                <h4>
                                                    <a href="friend-profile.html">Paul Molive</a>
                                                </h4>
                                                <h6>@developer</h6>
                                                <p>Lorem Ipsum is simply dummy text of the</p>
                                            </div>
                                ...
                                <div class="user-detail">
                                    <div class="d-flex flex-wrap justify-content-between align-items-start">
                                        <div class="profile-detail d-flex">
                                            ...
                                            <div class="user-data-block">
                                                <h4>
                                                    <a href="friend-profile.html">Anna Mull</a>
                                                </h4>
                                                <h6>@designer</h6>
                                                <p>Lorem Ipsum is simply dummy text of the</p>
                                            </div>
                                ...
                                <div class="user-detail">
                                    <div class="d-flex flex-wrap justify-content-between align-items-start">
                                        <div class="profile-detail d-flex">
                                            ...
                                            <div class="user-data-block">
                                                <h4>
                                                    <a href="friend-profile.html">Paige Turner</a>
                                                </h4>
                                                <h6>@tester</h6>
                                                <p>Lorem Ipsum is simply dummy text of the</p>
                                            </div>
                                ...
                                <div class="user-detail">
                                    <div class="d-flex flex-wrap justify-content-between align-items-start">
                                        <div class="profile-detail d-flex">
                                            ...
                                            <div class="user-data-block">
                                                <h4>
                                                    <a href="friend-profile.html">Bob Frapples</a>
                                                </h4>
                                                <h6>@developer</h6>
                                                <p>Lorem Ipsum is simply dummy text of the</p>
                                            </div>
                                ...
                                <div class="user-detail">
                                    <div class="d-flex flex-wrap justify-content-between align-items-start">
                                        <div class="profile-detail d-flex">
                                            ...
                                            <div class="user-data-block">
                                                <h4>
                                                    <a href="friend-profile.html">Barb Ackue</a>
                                                </h4>
                                                <h6>@grapfics</h6>
                                                <p>Lorem Ipsum is simply dummy text of the</p>
                                            </div>
                                ...
                                <div class="user-detail">
                                    <div class="d-flex flex-wrap justify-content-between align-items-start">
                                        <div class="profile-detail d-flex">
                                            ...
                                            <div class="user-data-block">
                                                <h4>
                                                    <a href="friend-profile.html">Greta Life</a>
                                                </h4>
                                                <h6>@fashion</h6>
                                                <p>Lorem Ipsum is simply dummy text of the</p>
                                            </div>
                                ...
                                <div class="user-detail">
                                    <div class="d-flex flex-wrap justify-content-between align-items-start">
                                        <div class="profile-detail d-flex">
                                            ...
                                            <div class="user-data-block">
                                                <h4>
                                                    <a href="friend-profile.html">Ira Membrit</a>
                                                </h4>
                                                <h6>@designer</h6>
                                                <p>Lorem Ipsum is simply dummy text of the</p>
                                            </div>
                                ...
                                <div class="user-detail">
                                    <div class="d-flex flex-wrap justify-content-between align-items-start">
                                        <div class="profile-detail d-flex">
                                            ...
                                            <div class="user-data-block">
                                                <h4>
                                                    <a href="friend-profile.html">Pete Sariya</a>
                                                </h4>
                                                <h6>@designer</h6>
                                                <p>Lorem Ipsum is simply dummy text of the</p>
                                            </div>
                                ...
                                <div class="user-detail">
                                    <div class="d-flex flex-wrap justify-content-between align-items-start">
                                        <div class="profile-detail d-flex">
                                            ...
                                            <div class="user-data-block">
                                                <h4>
                                                    <a href="friend-profile.html">Monty Carlo</a>
                                                </h4>
                                                <h6>@designer</h6>
                                                <p>Lorem Ipsum is simply dummy text of the</p>
                                            </div>
