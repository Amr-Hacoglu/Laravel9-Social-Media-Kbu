                        ...
                        <div class="post">
                            <div id="post-modal-data" class="card card-block card-stretch card-height">
                                <div class="card-header d-flex justify-content-between">
                                    ...
                                    <div class="card-body">
                                            <a href="/admin/createpost/edit/{{$data->id}}" class="btn btn-block btn-outline-success">Edit</a>
                                            <a href="/admin/createpost/delete/{{$data->id}}" class="btn btn-block btn-outline-danger">Delete</a>
                                    </div>
